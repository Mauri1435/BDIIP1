...
-- LIBRO            
    ...
    BEGIN
        ...
        -- Insertar el libro 
        INSERT INTO Libro (Titulo, ISBN, Edad_Recomendada, Inventario, ID_Editorial)
...
-- EDITORIAL 
    ...
    BEGIN
        ...
        IF v_tiene_libros > 0 THEN
            ...
            FOR r IN (SELECT ID_Libro FROM Libro WHERE ID_Editorial = p_id_editorial) 
            LOOP
                UPDATE Libro
                SET Activo = 0
...
-- LIBRO 
    ...
    BEGIN
        ...
        FROM Libro_Reserva lr
        JOIN Reserva r ON lr.ID_Reserva = r.ID_Reserva
...
CREATE OR REPLACE TRIGGER tr_actualizar_inventario_y_cantidad_reserva
...
CREATE OR REPLACE PACKAGE BODY pkg_reportes AS
    ...
    BEGIN
        FOR r IN (
            ...
            RIGHT JOIN Reserva r ON lr.ID_Reserva = r.ID_Reserva
    ...
    BEGIN
        FOR r IN (
            ...
            LEFT JOIN Reserva r ON lr.ID_Reserva = r.ID_Reserva
